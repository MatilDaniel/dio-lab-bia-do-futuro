...
O produto Fundo imobiliario (FIIs) substituiu o fundo Multimercado.
...
O exemplo de contexto montado abaixo, se basea nos dados originais da base de conhecimento, mas o sintetiza deixando somente as informações mais relevantes, otimizando assim o consumo de tokens. Enteretanto, vale lembrar que o mais importante do que econimizar tokens, é ter todas as informações relevantes disponíveis em seu contexto.
...
-LCI/LCA (RISCO BAIXO)
-Fundo Imobíliario FII (RISCO MÉDIO)
